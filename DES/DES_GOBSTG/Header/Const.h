...
#define GAME_TITLE			"–|·½»¨Ó³‰V Phantasmagoria of Flower View."
...
#define M_GAMESQUARE_SIDEEDGE_X_0	(M_CLIENT_LEFT-M_SIDE_EDGE_FULL/2)
#define M_GAMESQUARE_SIDEEDGE_X_1	(M_CLIENT_RIGHT+M_SIDE_EDGE_FULL/2)
#define	M_GAMESQUARE_SIDEEDGE_X_(X)	((X)?(M_GAMESQUARE_SIDEEDGE_X_1):(M_GAMESQUARE_SIDEEDGE_X_0))
