...
#define RESDEFAULT_FONTFONT				"Font/msgothic.ttc"
...
#define RESDEFAULT_EFFECTFOLDER		"EffectSys/"
...
#define RESCONFIGDEFAULT_KEYUP_1		PSP_BUTTON_UP
#define RESCONFIGDEFAULT_KEYDOWN_1		PSP_BUTTON_DOWN
#define RESCONFIGDEFAULT_KEYLEFT_1		PSP_BUTTON_LEFT
#define RESCONFIGDEFAULT_KEYRIGHT_1		PSP_BUTTON_RIGHT
#define RESCONFIGDEFAULT_KEYFIRE_1		PSP_BUTTON_SQUARE
#define RESCONFIGDEFAULT_KEYQUICK_1		PSP_BUTTON_CROSS
#define RESCONFIGDEFAULT_KEYSLOW_1		PSP_BUTTON_RIGHT_TRIGGER
#define RESCONFIGDEFAULT_KEYDRAIN_1		PSP_BUTTON_LEFT_TRIGGER
#define RESCONFIGDEFAULT_KEYUP_2		PSP_BUTTON_UP
#define RESCONFIGDEFAULT_KEYDOWN_2		PSP_BUTTON_DOWN
#define RESCONFIGDEFAULT_KEYLEFT_2		PSP_BUTTON_LEFT
#define RESCONFIGDEFAULT_KEYRIGHT_2		PSP_BUTTON_RIGHT
#define RESCONFIGDEFAULT_KEYFIRE_2		PSP_BUTTON_SQUARE
#define RESCONFIGDEFAULT_KEYQUICK_2		PSP_BUTTON_CROSS
#define RESCONFIGDEFAULT_KEYSLOW_2		PSP_BUTTON_RIGHT_TRIGGER
#define RESCONFIGDEFAULT_KEYDRAIN_2		PSP_BUTTON_LEFT_TRIGGER

#define RESCONFIGDEFAULT_KEYPAUSE	PSP_BUTTON_CIRCLE
#define RESCONFIGDEFAULT_KEYSKIP	PSP_BUTTON_TRIANGLE
#define RESCONFIGDEFAULT_KEYENTER	PSP_BUTTON_START
#define RESCONFIGDEFAULT_KEYESCAPE	PSP_BUTTON_SELECT
#define RESCONFIGDEFAULT_KEYCAPTURE	PSP_BUTTON_SELECT
...
#define RESCONFIGN_TURNOFFFLAG	"TurnOffFlag"
#define RESCONFIGDEFAULT_TURNOFFFLAG	TURNOFFFLAG_NONE
