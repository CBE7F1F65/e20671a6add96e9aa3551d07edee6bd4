M_DEFAULTIPPORT	=	17723

LConst_selsys_titleid	=	0
LConst_selsys_matchid	=	0
LConst_selsys_latencyid	=	1
LConst_selsys_player1id	=	2
...
LConst_uibg_bottomid	=	2
LConst_uibg_infoid	=	3
LConst_uibg_player1id	=	4
