...
//inner use
static BOOLu8 hzk_getfontinfo(PFont pfont, PFontInfo pfontinfo);
...
void expandchar(PFontHzk pf, int bg, int fg, int c, uint16* bitmap);
int getnextchar(char* s, unsigned char* cc);
void expandcchar(PFontHzk pf, int bg, int fg, unsigned char* c, uint16* bitmap);
...
BOOLu8 hzk_getfontinfo(PFont pfont, PFontInfo pfontinfo)
{
	PFontHzk pf = (PFontHzk)pfont;
	int i;
