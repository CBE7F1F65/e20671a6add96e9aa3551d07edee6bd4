...
public:
	...
	void				Fire();
	void				Stop(BOOLu8 bKillParticles = 0);
	void				Update(float fDeltaTime);
	void				MoveTo(float x, float y, BOOLu8 bMoveParticles = 0);
	void				Transpose(float x, float y) { fTx=x; fTy=y; }
	void				TrackBoundingBox(BOOLu8 bTrack) { bUpdateBoundingBox=bTrack; }
...
public:
	...
	BOOLu8				IsPSAlive(hgeParticleSystem *ps) const;
